...
const conservativeHoldings: Holding[] = [
  { id: "t1-h1", name: "中華電", weight: 30, cost: 122, plPercent: 5, purchaseDate: "2025-08-15" },
  { id: "t1-h2", name: "台泥", weight: 20, cost: 36, plPercent: -2, purchaseDate: "2025-11-03" },
  { id: "t1-h3", name: "兆豐金", weight: 25, cost: 42, plPercent: 8, purchaseDate: "2025-06-20" },
  { id: "t1-h4", name: "統一", weight: 15, cost: 72, plPercent: 3, purchaseDate: "2026-01-10" },
  { id: "t1-h5", name: "中鋼", weight: 10, cost: 25, plPercent: -1, purchaseDate: "2026-03-05" },
];
...
const techGrowthHoldings: Holding[] = [
  { id: "t2-h1", name: "台積電", weight: 45, cost: 980, plPercent: 15, purchaseDate: "2026-03-12" },
  {
    id: "t2-h2",
    name: "聯發科",
    weight: 25,
  ...
  { id: "t2-h3", name: "廣達", weight: 20, cost: 285, plPercent: 22, purchaseDate: "2026-02-08" },
  { id: "t2-h4", name: "緯創", weight: 10, cost: 118, plPercent: -3, purchaseDate: "2026-06-01" },
];
...
const swingTraderHoldings: Holding[] = [
  { id: "t3-h1", name: "長榮", weight: 25, cost: 195, plPercent: -6, purchaseDate: "2026-06-25" },
  { id: "t3-h2", name: "陽明", weight: 20, cost: 68, plPercent: 4, purchaseDate: "2026-07-01" },
  { id: "t3-h3", name: "華航", weight: 15, cost: 22, plPercent: 10, purchaseDate: "2026-06-18" },
  { id: "t3-h4", name: "聯電", weight: 20, cost: 52, plPercent: -2, purchaseDate: "2026-07-03" },
  { id: "t3-h5", name: "國巨", weight: 20, cost: 520, plPercent: 7, purchaseDate: "2026-06-30" },
];
