...
export const ledgerTemplates: LedgerTemplate[] = [
  {
    ...
    name: "穩健存股型",
    holdings: [
      { name: "中華電", weight: 30, cost: 122, plPercent: 5, purchaseDate: "2025-08-15" },
      { name: "台泥", weight: 20, cost: 36, plPercent: -2, purchaseDate: "2025-11-03" },
      { name: "兆豐金", weight: 25, cost: 42, plPercent: 8, purchaseDate: "2025-06-20" },
      { name: "統一", weight: 15, cost: 72, plPercent: 3, purchaseDate: "2026-01-10" },
      { name: "中鋼", weight: 10, cost: 25, plPercent: -1, purchaseDate: "2026-03-05" },
    ],
    principles: [
      {
    ...
    memories: [
      { quote: "領到股息就覺得安心，比價差重要", date: "2026-07-01", source: "配息入帳" },
      {
  ...
  },
  {
    ...
    name: "科技成長型",
    holdings: [
      { name: "台積電", weight: 45, cost: 980, plPercent: 15, purchaseDate: "2026-03-12" },
      { name: "聯發科", weight: 25, cost: 1280, plPercent: -8, purchaseDate: "2026-05-20" },
      { name: "廣達", weight: 20, cost: 285, plPercent: 22, purchaseDate: "2026-02-08" },
      { name: "緯創", weight: 10, cost: 118, plPercent: -3, purchaseDate: "2026-06-01" },
    ],
    principles: [
      {
  ...
  },
  {
    ...
    name: "波段操作型",
    holdings: [
      { name: "長榮", weight: 25, cost: 195, plPercent: -6, purchaseDate: "2026-06-25" },
      { name: "陽明", weight: 20, cost: 68, plPercent: 4, purchaseDate: "2026-07-01" },
      { name: "華航", weight: 15, cost: 22, plPercent: 10, purchaseDate: "2026-06-18" },
      { name: "聯電", weight: 20, cost: 52, plPercent: -2, purchaseDate: "2026-07-03" },
      { name: "國巨", weight: 20, cost: 520, plPercent: 7, purchaseDate: "2026-06-30" },
    ],
    principles: [
      {
    ...
    memories: [
      ...
      { quote: "最近做太多筆了，手續費加起來也不少", date: "2026-07-06", source: "交易成本" },
      {
